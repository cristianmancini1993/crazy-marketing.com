# crazy-marketing.com — COD Multi-Geo Static Site
...
- **Domain**: crazy-marketing.com
- **Company**: EASY PEASY GROUP LIMITED — FLAT/RM A 15/F GOLDFIELD INDUSTRIAL BUILDING 144-150 TAI LIN PAI ROAD — Kwai Chung, Hong Kong
- **Contact email**: info@crazy-marketing.com (auto-derived from domain)
...
This site is **100% static**. Deploy by uploading the entire `/crazy-marketing.com/` folder to any static host:
